...
export default function Profile() {
    ...
    return (
        <div className="mt-auto border-t border-border/30 p-2 bg-background/50 backdrop-blur-[2px]">
            <div className="flex items-center gap-3 p-2 rounded-md hover:bg-accent/40 transition-colors cursor-pointer">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button className="w-8 h-8 rounded-md hover:bg-accent/50 flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors" title="Settings">
